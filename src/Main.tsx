...
const Main: React.FC<MainProps> = ({ isSidebarOpen }) => {
    ...
    return (
        <div className="Main" style={{ paddingLeft: `${paddingLeft}px` }}>
            <div className="Top">
                <button onClick={prevSlide}><BiChevronLeft size="40" /></button>
                <div className="Slide">
                    <img className="Slide_img" src={images[currentSlide]} alt={slides[currentSlide]} />
